...
1.  [What even is an FPGA? How do they differ from microcontrollers. What actually changes during reconfiguration.](#org25b74f9)
2.  [Question about + operator on wires](#orgb4da094)
3.  [Logic vs wire vs others - 2 state vs 4 state](#org5a116b6)
4.  [blocking and nonblocking assignment](#org7fbb945)
5.  [What does timescale do?](#orgeca42b6)
6.  [Sites I bailed out to for help getting my Verilog testbench working-](#org29d74f9)
7.  [TODO](#org756a435)
    1.  [#delays for S.V. testbenches](#org43fb302)
    2.  [Design vs testbench](#org5304a6f)
    3.  [Initial states of nets](#org5ebf24e)
    4.  [Signed vs unsigned](#org2505091)
    5.  [Icarus verilog, steps in compilation and simulation](#org65a784e)
    6.  [Gtkwave and tracing](#orgfdf6c21)
        1.  [dumpvars syntax, number of levels of hierarchy traced](#org597ae5c)
...
3.  Z represents an abstract digital high-impedance. In a multi-driver circuit, a value of 0 or 1 will override a Z. Some programming operators and programming statements treat Z values as don’t care values (see Chapter 5, section 5.9, page 171, and Chap­ ter 6 section 6.2.2, page 223).
